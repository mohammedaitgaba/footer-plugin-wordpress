...
single file with one line of content. Navigate to the wp-content/plugins folder, 
and create a new folder named "exemple_plugin". 
Inside this new folder, create a file named "exemple_plugin.php". 
